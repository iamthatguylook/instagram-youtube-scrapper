...
if os.path.exists(downloadPath):    # If the Path outputFolder exists in current directory it will delete and recreate it as we dont want have have the old videos as they were previously scrapped
